...
public class OrderTest {
    ...
    @Test
    void checkAppetizer() {
        assertThat(OrderedMenu.checkAppetizer(orderedMenu)).isEqualTo(3);
    }

    @DisplayName("주문 메뉴에서 메인 개수 체크")
    @Test
    void checkMain() {
        assertThat(OrderedMenu.checkMain(orderedMenu)).isEqualTo(4);
    }

    @DisplayName("주문 메뉴에서 디저트 개수 체크")
    @Test
    void checkDessert() {
        assertThat(OrderedMenu.checkDessert(orderedMenu)).isEqualTo(2);
    }

    @DisplayName("주문 메뉴에서 음료 개수 체크")
    @Test
    void checkDrink() {
        assertThat(OrderedMenu.checkDrink(orderedMenu)).isEqualTo(3);
    }
    ...
    void calculateTotalAmount() {
        assertThat(OrderedMenu.calculateTotalAmount(orderedMenu)).isEqualTo(319000);
    }
