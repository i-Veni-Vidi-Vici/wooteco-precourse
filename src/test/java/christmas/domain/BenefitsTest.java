...
public class BenefitsTest {
    ...
    void calculateChristmas(Integer day, Integer discountPrice) {
        assertThat(Xmas.calculate(day)).isEqualTo(discountPrice);
    }
    ...
    void calculateChristmasUntil25th() {
        for (int day = 1; day <= 25; day++) {
            assertThat(Xmas.calculate(day)).isEqualTo(1000 + (day - 1) * 100);
        }
    }
    ...
    void calculateChristmasAfter25th() {
        for (int day = 26; day <= 31; day++) {
            assertThat(Xmas.calculate(day)).isEqualTo(0);
        }
    }
...
//    }
    ...
    void calculateWeekdayByWeekday(Integer day) {
        assertThat(Weekday.calculate(day, reservedMenu)).isEqualTo(2023 * 2);
    }
    ...
    void calculateWeekdayByWeekend(Integer day) {
        assertThat(Weekday.calculate(day, reservedMenu)).isEqualTo(0);
    }
    ...
    void calculateWeekendByWeekday(Integer day) {
        assertThat(Weekend.calculate(day, reservedMenu)).isEqualTo(0);
    }
    ...
    void calculateWeekendByWeekend(Integer day) {
        assertThat(Weekend.calculate(day, reservedMenu)).isEqualTo(2023 * 4);
    }
    ...
    void calculateSpecialByTheDay(Integer day) {
        assertThat(Special.calculate(day)).isEqualTo(1000);
    }
    ...
    void calculateSpecialByNotTheDay(Integer day) {
        assertThat(Special.calculate(day)).isEqualTo(0);
    }
    ...
    void calculateTotalDiscountByWeekend(Integer day) {
        assertThat(Benefits.calculateTotalBenefit(day, reservedMenu.calculateTotalAmount(),
